            ...
            return{
                ...
                pickerOptions2: {
                   ...
                   type_exp:[['分类','Other'],['导出','Export']],
                    typearr1:[['累计用户','Total User'],['新增用户','New User'],['增长率','Growth Rate'],['活跃用户','Active User']]
            }
        },
    created(){
    ...
    watch:{
        ...
        addclose(n,o){
            ...
            var newchart1 = setInterval(()=>{
                window.totaluser.resize()
            },100)
            var newchart2 = setInterval(()=>{
                window.activeuser.resize()
            },100)
            setTimeout(()=>{
            ...
            console.log(this.$store.state.moneyty,this.$store.state.requesttime)
                    ...
                    Axios.post(url,{
                                        ...
                                        this.arr.forEach(e => {
                                            ...
                                            this.newarr[0].unshift(e.chain_total_user)
                                            this.newarr[1].unshift(e.chain_new_user)
                                            this.newarr[2].unshift(e.chain_new_user_rate)
                                            this.newarr[3].unshift(e.chain_active_user)
                                        });
                                        this.drawall()
